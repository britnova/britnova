...
export default function TestimonialCarousel() {
  ...
  return (
    <section id="testimony" className="py-28 border-b border-border-subtle bg-bg-card/40 relative overflow-hidden">
            ...
            {testimonials.map((_, index) => (
              <button
                ...
                className={`w-2.5 h-2.5 rounded-full transition-all duration-300 ${
                  index === activeIndex ? 'bg-brand-accent w-6' : 'bg-border-subtle hover:bg-text-muted'
                }`}
